            ...
            <View style={{ flex: 1, position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(1, 1, 1, 0.5)' }}>
                ...
                <View style={styles.formContainer}>
                    ...
                    <View style={{ marginTop: 20 }}>
                        ...
                        <Input type="email" placeholder="Enter your email" placeholderTextColor="#ccc" />
                    </View>
                    <View style={{ marginTop: 20 }}>
                        <Text style={styles.label}>Password</Text>
                        <Input type="password" placeholder="Enter your password" placeholderTextColor="#ccc" />
                    </View>
                    <View style={{ marginTop: 20, alignItems: "flex-end" }}>
                        <Text style={{ color: "yellow" }}>Forgot your password?</Text>
                    </View>
                    <Button onPress={handleSignIn} style={{ marginTop: 20 }} text="Sign In" />
                </View>
            </View>
        </ThemedView>
    )
